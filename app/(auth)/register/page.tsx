  ...
  return (
    <div className='w-full h-[100vh] flex justify-center items-center text-black'>
      <form 
        ...
        className="space-y-4 p-10 max-w-md mx-auto relative shadow-lg w-[20%] rounded-[10px]"
      >
        {loading && (
        ...
        <h1 className="text-lg font-bold mb-2">Sign up to Novaq</h1>
        ...
        <div className="text-sm text-center">
          Already have an account? <a href="/login" className='text-[#4D3BED] hover:underline'>Sign in</a>
        </div>
      </form>
    </div>
  );
