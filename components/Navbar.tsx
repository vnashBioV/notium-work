      ...
      <div className="h-full flex flex-col p-4 space-y-4">
        ...
        <nav className="flex flex-col gap-2">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded cursor-pointer ${
              isActive('/dashboard') ? 'bg-[#4D3BED] text-white' : 'text-black hover:bg-gray-100'
            }`}
          >
            <Home size={18} />
            <span>Home</span>
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded cursor-pointer ${
              isActive('/projects') ? 'bg-[#4D3BED] text-white' : 'text-black hover:bg-gray-100'
            }`}
          >
          ...
          <button
            onClick={() => { router.push('/calendar'); setSidebarOpen(false); }}
            className={`flex items-center gap-2 px-4 py-2 rounded cursor-pointer ${
              isActive('/calendar') ? 'bg-[#4D3BED] text-white' : 'text-black hover:bg-gray-100'
            }`}
          >
            <Calendar size={18}/>
            <span>Calendar</span>
        ...
        <div className="mt-auto text-center">
          <button
            ...
            className={`flex items-center justify-center gap-2 px-4 py-2 rounded w-full cursor-pointer ${
              isActive('/settings') ? 'bg-[#4D3BED] text-white' : 'text-black hover:bg-gray-100'
            }`}
          >
            <Settings size={25}/>
          </button>
